...
SECRET_KEY = 'django-insecure-wk6*0_sv=c#_&zzxe-t@s4rovcn&6s$qf6pc^ydub7)#7q+*v0'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'voting_db',
        'USER': 'root',       # உங்க MySQL User Name (பொதுவா root)
        'PASSWORD': 'root',       # உங்க MySQL Password (இல்லன்னா காலியா விடுங்க)
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
